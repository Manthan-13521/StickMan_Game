      ...
      players: [
        {
          ...
          lastProcessedInput: this.players[0].getLastProcessedSeq(),
          ultimateReady: this.players[0].ultimateReady,
          timestamp: Date.now(),
        },
        {
          ...
          lastProcessedInput: this.players[1].getLastProcessedSeq(),
          ultimateReady: this.players[1].ultimateReady,
          timestamp: Date.now(),
        },
      ],
      round: this.round,
